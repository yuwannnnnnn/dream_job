...
<body>
	...
	<form action="core/handleForms.php" method="POST">
            ...
            <p><label for="birthDate">Birthday</label> <input type="text" name="birthDate"></p>
            ...
            <p><label for="experience">Years of experience</label> <input type="text" name="experience">
                <input type="submit" name="insertApplicationBtn">
            </p>
	</form>
